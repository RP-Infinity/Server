...
/* System Settings */
    ...
    gang_upgradeBase = 60000; //The base cost for purchasing additional slots in a gang
    ...
    paycheck_cop = 800; //Payment for cops
    paycheck_civ = 1250; //Payment for civillians
    paycheck_med = 800; //Payment for medics

    paycheck_period = 5; //Scaled in minutes
    bank_transferTax = .08; //Tax that player pays when transferring money from ATM. Tax = Amount * multiplier
    ...
    vehicle_purchase_multiplier_CIVILIAN = 2.3; //Civilian Vehicle Buy Price = Config_Vehicle price * multiplier
    vehicle_purchase_multiplier_COP = 1.75; //Cop Vehicle Buy Price = Config_Vehicle price * multiplier
    vehicle_purchase_multiplier_MEDIC = 1.75; //Medic Vehicle Buy Price = Config_Vehicle price * multiplier
    ...
    vehicle_storage_fee_multiplier = .33; //Pull from garage cost --> Cost takes the playersides Buy Price * multiplier
